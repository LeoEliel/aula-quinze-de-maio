...
# Resolve o diretório raiz do projeto independente de onde o pytest é chamado.
# Necessário porque o mutmut copia arquivos para uma subpasta mutants/ antes de rodar.
_PROJECT_ROOT = Path(__file__).resolve().parent
# Se o arquivo está dentro de mutants/, sobe um nível a mais
...
scenarios(f"{_FEATURES}/saldo_extrato.feature")
